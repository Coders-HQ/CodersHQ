...
MIGRATION_MODULES = {"sites": "codershq.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                # "codershq.utils.context_processors.settings_context",
                "codershq.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "codershq.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "codershq.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
...
# eventbrite
EVENTBRITE_TOKEN = env.str("EVENTBRITE_TOKEN", "")
EVENTBRITE_ORGANIZATION_ID = env.str("EVENTBRITE_ORGANIZATION_ID", "")
