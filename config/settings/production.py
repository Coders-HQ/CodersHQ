...
# Static files are currently served using WhiteNoise and are stored on the VM.
# If we decide to move them to a separate Azure storage later on:
...
SAML_IDP_SP_FIELD_DEFAULT_ATTRIBUTE_MAPPING = {"email": "email", "first_name": "firstName", "last_name": "lastName"} #first field is from the user model, second field is the SAML attribute name
