...
class SponsorshipTypes(models.Model):
    ...
    sponsorship_description = models.CharField(
        _("Company sponsorship description"), max_length=250
    )
...
class Sponsorships(models.Model):
    ...
    sponsorship_value = models.PositiveIntegerField(
        _("Sponsorship Value"), default=0, validators=[MaxValueValidator(10000000)]
    )
