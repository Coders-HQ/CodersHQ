...
from codershq.companies.views import CompanyListView, CompanyFormView, CompanyCreateView, CompanyUpdateView, CompanyDeleteView

from . import views

app_name = "companies"
urlpatterns = [
    path('', CompanyFormView.as_view(), name='company-list'),
